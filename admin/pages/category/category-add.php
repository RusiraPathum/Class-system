...
<head>
  ...
  <title>Class | Category List</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ">
                <a href="../category/category-add.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Category</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Category Add and List</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <div class="col-md-12">
                <form>
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-12 ">
                        <label for="NIC_no">Courses Name</label>
          ...
          <div class="card-footer">
            <input class="btn btn-primary" onclick="categoryAdd()" id="category_add"
                   type="submit"
                   value="Add Category">
          </div>
        </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                <input type="hidden" class="form-control" id="update_idcategory" name="update_idcategory" disabled >
              </div>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-12 ">
                    <label for="update_name">Courses Name</label>
          ...
          <div class="modal-footer justify-content-end">
            <div class="">
              <input class="btn btn-primary" id="update_category"
                     type="submit"
...
<script src="../../custom/js/categoryJs/category-add.js"></script>
<script src="../../custom/js/categoryJs/category-update.js"></script>
